...
export const getStandardApplicationDescription =
  (): string => t`The base data model every PTS AI CRM workspace runs on.

#### What "foundation" means

Every PTS AI CRM workspace starts with this set of objects. They define the shape of your CRM, including relationships, activity, and reporting. Everything else, including marketplace apps, AI agents, and custom objects, plugs into them.
...
Extend the CRM with your own objects, fields, logic functions, or AI skills. Scaffold a new app in one command:
